...
%%
%% Background.
%% In this section I would state which is the problem that I am
%% actually trying to tackle. For doing that, I will try to state 
%% which is the problem from the company perspective
\section{Background}

%% In this part I will state the different observability plattforms and a 
%% review of what is data observability and SLOs.
\section{Literature review}

%% In this part it would be good to compare between: Amplitude, Datadog, Google cloud monitoring
